...
@section ('breadcrumb')
  <nav aria-label="breadcrumb" class="mt-4">
    <ol class="breadcrumb breadcrumb-style1">
      ...
      <li class="breadcrumb-item">
        <a href="/project/{{ $project_detail->id_project }}">{{ $project->nama_project }}</a>
      </li>
      <li class="breadcrumb-item active">
        <a href="/project/desc/{{ $project_detail->id_project }}">Detail</a>
      </li>
    </ol>
  </nav>
@endsection
        ...
        <div class="row">
            ...
            @if (Auth::user()->jabatan == 'Direktur' && $project->status == 'sedang_berjalan') 
                <div class="col-3 mt-3" style="text-align: right;">
                    <a href="/Edit-Detail/{{ $project_detail->id_project }}" class="btn btn-primary" style="margin-right: 20%;"><i class="bx bx-edit me-2" style="margin-bottom:2px "></i>Edit</a>
                </div>
            @endif
