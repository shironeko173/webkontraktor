    ...
    <ol class="breadcrumb breadcrumb-style1">
      @if (Auth::user()->jabatan == 'Pengawas_Lapangan' ||Auth::user()->jabatan == 'Admin'|| Auth::user()->jabatan == 'Drafter')
          ...
          <li class="breadcrumb-item active">
            <a href="/project/Laporan-Progress/{{ $detail_project->id_project }}">Laporan Progress</a>
          </li>
      @else
          <li class="breadcrumb-item">
...
@section('content')
  <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <!-- Bordered Table -->
    <div class="card">
      <h5 class="card-header">Laporan Progress, Project : {{ $detail_project->nama_project }}</h5>
      <div class="card-body">
