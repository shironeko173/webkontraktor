  ...
  <nav aria-label="breadcrumb" class="mt-4">
    <ol class="breadcrumb breadcrumb-style1">
      ...
      <li class="breadcrumb-item active">
        <a href="/stafflapangan/Laporan-RAB/{{ $project->id_project }}">Laporan RAB</a>
      </li>
    </ol>
  </nav>
@endsection
...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="container bg-light shadow py-3 px-5">
            ...
            <div class="d-flex justify-content-end my-4">
                ...
                data-bs-target="#modalCenter">Upload Laporan RAB</a>
            </div>
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <tr>
                            ...
                            @if ($item->status == 'Belum Dikirim')
                                <td style="text-align: center;">
                                    <a href="/storage/laporanRAB/{{ $item->dokumen }}" target="_blank" class="btn btn-primary btn-sm"><i class="bi bi-eye"></i></a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="modalCenterTitle">Upload Laporan RAB</h5>
              <button
                type="button"
                class="btn-close"
    ...
    <form method="POST" action="/Upload-LaporanRAB/{{ $idproject }}" enctype="multipart/form-data">
        @csrf
            <div class="modal-body">
              <div class="row">
                <div class="col mb-3">
                
                  <label for="formFile" class="form-label">File Laporan RAB</label>
