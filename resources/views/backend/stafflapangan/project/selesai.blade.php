              ...
              <div class="card mt-3" >
                  <div class="d-flex align-items-end row">
                      <div class="card-body" style="padding-bottom: 1rem;">
                              ...
                              <div class="col col-lg-1" style="text-align: center;"><h5>View More</h5> <a href="/project/laporan/{{ $item->id_project }}" type="button" class="btn btn-outline-primary"><span class="tf-icons bx bx-log-in-circle"></span></a></div>
