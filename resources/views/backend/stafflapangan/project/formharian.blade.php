...
@endpush
@section('content')
@include('backend.stafflapangan.project.form')
@if (Route::is('viewlaporan'))
    @include('backend.stafflapangan.project.formview')

@else
@include('backend.stafflapangan.project.formedit')
    @endif
    @section('js')
