  ...
  <nav aria-label="breadcrumb" class="mt-4">
    <ol class="breadcrumb breadcrumb-style1">
      ...
      <li class="breadcrumb-item active">
        <a href="/projectmanager/Dokumen-Tambahan/{{ $project->id_project }}">Dokumen Tambahan</a>
      </li>
    </ol>
  </nav>
@endsection
        ...
        <div class="col py-5">
            <div class="card h-100">
              ...
              <div class="card-img-overlay" style="padding: 5%;">
                <h1 class="card-title mt-4" style="text-align: center; color:white">Dokumen Tambahan</h1>
              </div>
          ...
          <div class="row mb-4">
              ...
              <div class="col-md-6 col-lg-6 mb-3 ">
                <a href="/projectmanager/Dokumen-Tambahan/pending/{{ $project->id_project }}"><div class="card h-100">
              ...
              <div class="col-md-6 col-lg-6 mb-3 ">
                <a href="/projectmanager/Dokumen-Tambahan/accept/{{ $project->id_project }}"><div class="card h-100">
