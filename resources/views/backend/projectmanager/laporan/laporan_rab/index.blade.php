  ...
  <nav aria-label="breadcrumb" class="mt-4">
    <ol class="breadcrumb breadcrumb-style1">
      ...
      <li class="breadcrumb-item active">
        <a href="/projectmanager/Laporan-RAB/{{ $project->id_project }}">Laporan RAB</a>
      </li>
    </ol>
  </nav>
@endsection
        ...
        <div class="col py-5">
            <div class="card h-100">
              ...
              <div class="card-img-overlay" style="padding: 5%;">
                <h1 class="card-title mt-4" style="text-align: center; color:white">Laporan RAB</h1>
              </div>
          ...
          <div class="row mb-4">
              ...
              <div class="col-md-6 col-lg-6 mb-3 ">
                <a href="/projectmanager/Laporan-RAB/pending/{{ $project->id_project }}"><div class="card h-100">
              ...
              <div class="col-md-6 col-lg-6 mb-3 ">
                <a href="/projectmanager/Laporan-RAB/accept/{{ $project->id_project }}"><div class="card h-100">
