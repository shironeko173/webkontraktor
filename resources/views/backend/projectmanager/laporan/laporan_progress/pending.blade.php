  ...
  <nav aria-label="breadcrumb" class="mt-4">
    <ol class="breadcrumb breadcrumb-style1">
      ...
      <li class="breadcrumb-item active">
        <a href="/projectmanager/Laporan-Progress/{{ $detail_project->id_project }}">Laporan Progress</a>
      </li>
    </ol>
  </nav>
@endsection
...
@section('content')
  <div class="container-xxl flex-grow-1 container-p-y">
      ...
      <!-- Bordered Table -->
    <div class="card">
      <h5 class="card-header">Verifikasi Laporan Progress, Project : {{ $detail_project->nama_project }}</h5>
      <div class="card-body">
