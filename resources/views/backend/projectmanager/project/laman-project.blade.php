  ...
  <nav aria-label="breadcrumb" class="mt-4">
    <ol class="breadcrumb breadcrumb-style1">
      ...
      <li class="breadcrumb-item active">
        ...
        @else
          <a href="/projectmanager/selesai/{{ $project->id_project }}">{{ $project->nama_project }}</a>
        @endif
...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="col py-5">
          ...
          <div class="row mb-4">
            @if(Auth::user()->jabatan == 'Project_Manager')

              <div class="col-md-6 col-lg-6 mb-3 "> 
                <a href="/projectmanager/sb-desc/{{ $project->id_project }}"><div class="card h-100">

                  <img class="card-img" src="https://picsum.photos/1800/900?grayscale, black&1" alt="Card image cap" style="height: 200px;" />
              ...
              <div class="col-md-6 col-lg-6 mb-3 ">
                <a href="/projectmanager/sb-team/{{ $project->id_project }}"><div class="card h-100">

                  <img class="card-img" src="https://picsum.photos/1800/900?grayscale, black&2" alt="Card image cap" style="height: 200px;" />
                    <div class="card-img-overlay" style="padding: 8%;">
              ...
              <div class="col-md-6 col-lg-6 mb-3 ">
                <a href="/projectmanager/sb-laporan/{{ $project->id_project }}"><div class="card h-100">

                  <img class="card-img" src="https://picsum.photos/1800/900?grayscale, black&3" alt="Card image cap" style="height: 200px;" />
                    <div class="card-img-overlay" style="padding: 8%;">
